    ...
    def patch(self, application_id):
        ...
        try:
            ...
            if data['status'] == 'approved':
                ...
                payment_url = f"https://propertygalaxy201.netlify.app/agent-payment?userId={application.user_id}&applicationId={application.id}"  # Replace with your actual payment URL
