...
class PropertiesAgentResource(Resource):
    def get(self, id):
        ...
        return [{'id': property.id, 'property': property.address,'city':property.city ,'square_footage':property.square_footage,'price':property.price,'property_type': property.property_type,'listing_status':property.listing_status}for property in properties]
